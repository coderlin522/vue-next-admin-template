<template>
	<div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
		<el-dropdown :show-timeout="70" :hide-timeout="50" trigger="click" @command="onLanguageChange">
			<div class="layout-navbars-breadcrumb-user-icon" title="中英切换">
				<l-svg-icon name="change-language"></l-svg-icon>
			</div>
			<template #dropdown>
				<el-dropdown-menu>
		...
		<div
			...
			:title="!state.isScreenfull ? '开启全屏' : '取消全屏'"
			@click="onScreenfullClick"
		>
			<l-svg-icon :name="!state.isScreenfull ? 'fullscreen' : 'cancel-full'"></l-svg-icon>
		</div>
